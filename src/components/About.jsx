...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="bg-custom-purple h-full p-6 px-12 pt-20 text-custom-text"
    >
      <MaxWidthWrapper>
        <div>
          <h1 className="text-4xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[#5A639C] from-3% to-[#37B7C3] to-77% pt-10">
            About Me
          </h1>
        </div>
            ...
            <div className="flex justify-between h-48">
              ...
              <div className="w-1/3 ">
                ...
                <div className="p-3 text-md italic">
                  Developing Frontend Designs for web applications using mainly
                  HTML, CSS and Javascript or frameworks like React.js and
                  Next.js.{" "}
                </div>
                {/* JOB DATE */}
            ...
            <div className="flex justify-between h-48">
              ...
              <div className="w-1/3 ">
                ...
                <div className="p-3 text-sm italic">
                  ...
                  queries, and designing and optimizing databases using MySQL or
                  MongoDB.{" "}
                </div>
                {/* JOB DATE */}
                <div className="p-3 text-red-400 text-sm font-semibold">
