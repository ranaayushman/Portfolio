...
const Header = () => {
  return (
    <header className="bg-custom-purple text-custom-text">
      <MaxWidthWrapper>
        <nav className="flex flex-col sm:flex-row justify-between p-6">
          ...
          <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-6 gap-4">
            <a href="#projects" className="text-xl hover:text-slate-200">
              Projects
            </a>
